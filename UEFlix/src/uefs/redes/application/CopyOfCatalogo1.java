 ...
 * @author Arthur
 */
public class CopyOfCatalogo1 extends javax.swing.JFrame {

    /**
     * Creates new form Catalógo
     */
   private ArrayList<MovieInformation> movies ;
    public CopyOfCatalogo1() {
        initComponents();
    ...
    public CopyOfCatalogo1(ControllerClient x)
    {
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
       try {
           ...
           Logger.getLogger(CopyOfCatalogo1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CopyOfCatalogo1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
			public void run() {
                new CopyOfCatalogo1().setVisible(true);
            }
        });
    }
