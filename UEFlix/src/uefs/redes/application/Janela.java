   ...
   private int h = 0;
    ...
    public Janela()
    {
     ...
     searchField.setPreferredSize( new Dimension (200,30));
        ...
        MovieInformation a  = new MovieInformation("title", "dsadas", 1, "asdada");  
        MovieInformation a2  = new MovieInformation("title2", "dsadas2", 1, "asdada2");  
        for(int i = 0; i<10; i++)
        { 
            h=i;
           ...
           if(i%2==0)
           	a1.addActionListener(new MyEvent(a));
           else
        	   a1.addActionListener(new MyEvent(a2)); 
