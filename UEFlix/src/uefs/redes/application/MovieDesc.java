        ...
        try {
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                    	PlayMovie browser;
                    	 if (choose.equals("low")){
                    		 browser = new PlayMovie(away + "\\clientmovie\\" +infMov.getName_file()+"-"+choose+ ".mp4", 640, 360);
                    	 }
                    	 else{
                    		 browser = new PlayMovie(away + "\\clientmovie\\" +infMov.getName_file()+"-"+choose+ ".mp4", 1280, 720);
                    	 }
